...
const Header = () => {
  return (
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' style={{backgroundImage : "url('/header_img.png')"}}  id="Header"  >
      <Navbar />
      <motion.div initial={{opacity: 0, y:100}} transition={{duration:1.5}} whileInView={{opacity:1, y:0}} viewport={{once: true}} className='container text-center mx-auto py-6 px-6 md:px-20 lg:px-32 text-white'>
        <h2 className='text-4xl sm:text-5xl md:text-[70px] inline-block max-w-2xl font-semibold pt-15'>Explore homes that fit your dreams</h2>
